...
(function (global) {
  ...
  const sr = {
    ...
    'meta.desc': 'Pravim sajtove koji prodaju. Vidi se šta nudiš, kuda se ide, i šta da se klikne — da poseta postane poziv, ne samo pregled.',
    'jsonld.job': 'Web dizajner i programer',
    'jsonld.catalog': 'Sajtovi i aplikacije',
    'jsonld.offer.launch': 'Jedna ponuda, jedan put do kupovine ili termina.',
    'jsonld.offer.growth': 'Prodavnica, termini ili duži sajt koji stvarno proda.',
    'jsonld.offer.custom': 'Aplikacije i čudni projekti — prvo pričamo.',
    ...
    'hero.lead': 'Većina sajtova izgleda skupo, a ne proda ništa. Ja napravim da se odmah vidi šta nudiš, kuda se ide, i šta da kliknu — da ne mogu da promase.',
    'hero.scroll': 'Idi naniže',
    'cta.talk': 'Hajde da pričamo',
    'cta.viewWork': 'Vidi radove',
    'cta.book': 'Zakaži poziv',
    'cta.seeWork': 'Vidi šta sam radio',
    'cta.startBuild': 'Krenimo',
    'cta.workWithMe': 'Radi sa mnom',
    'cta.seeNumber': 'Vidi cenu',
    ...
    'work.bs.copy': 'Program je bio dobar. Sajt nije. Ljudi nisu znali za koga je, šta rade tih 90 dana, ni gde da plate. Složio sam ga kao razgovor sa trenerom: šta boli, šta dobijaš, kako ide, pa kupovina u jednom koraku. To je bio ceo sajt — tekst, telefon, i put do pare. Ne katalog.',
    'work.bs.copyMobile': 'Nisu znali za koga je ni gde da plate. Složio sam: problem, obećanje, kupovina.',
    'work.lk.services': 'Prodavnica',
    'work.lk.copy': 'Lenkolino pravi dekor za dečije sobe — baloni, čestitke, pokloni po meri. Kupovina na starom sajtu je delovala kao još jedan posao. Napravio sam prodavnicu gde se odmah vidi šta kupuješ, zašto da veruješ, i gde je kasa. Korpa i proizvodi, ne lep katalog sa formularem na dnu. Growth paket, sa dogovorenim rokom.',
    ...
    'work.tm.copy': 'Marina ima praksu. Ko je sleteo na staro nije video šta nudi, ni kako da uzme termin. Napravio sam sajt oko nje: ko je, šta radi, i uvod od pola sata u kalendaru. Launch paket — tekst, raspored, termini pre nego što je izašao.',
    ...
    'work.stat.sales': 'Prodaja online',
    ...
    'about.lead': 'Ja sam Goran. Pravim sajtove od kojih ostane novac, ne sajtove koji samo lepo stoje. Ako ti dolaze ljudi a ne javljaju se — sredim šta nudiš, kuda idu, i šta da kliknu. Da neko ko te prvi put vidi, u jednom prolazu shvati šta da uradi.',
    'about.photo': 'Goran — G8 Flow',

    'process.eyebrow': 'Kako to ide',
    'process.h2': 'Pričamo. Sredimo. Pravim. Puštam.',
    'process.s1.title': 'Pričamo',
    'process.s1.text': 'Pola sata. Gledam gde ti sajt gubi pare — i da li sam ja čovek za to.',
    'process.s2.title': 'Sredimo',
    'process.s2.text': 'Za koga je, šta kupuju, šta da kliknu. Dok to nije jasno, ne crtamo.',
    'process.s3.title': 'Pravim',
    'process.s3.text': 'Dobiješ pravi link, ne sliku u poruci. Gledaš uživo. Rupu ne lepim dizajnom.',
    'process.s4.title': 'Puštam',
    'process.s4.text': 'Izađe, radi, prima novac. Posle toga držim da ne crkne.',
    ...
    'sol.app.title': 'Aplikacije koje ljudi stvarno otvore',
    'sol.app.text': 'Ne uzimam šablon i ne menjam boju. Prvo za koga je, pa skica, pa stvar koju će da drže u džepu.',
    ...
    'ind.ecom.1': 'Prodavnica gde se vidi zašto da uzmeš, ne samo slika i cena',
    'ind.ecom.2': 'Plaćanje koje ne izgleda kao kazna',
    'ind.ecom.3': 'Kartica, dostava, stanje na lageru — da stvarno možeš da prodaš',
    'ind.ecom.4': 'Katalog koji ne umre kad imaš dosta artikala',
    ...
    'ind.hos.2': 'Šta nudiš, sobe, i zašto da ti veruju — u jednom prolazu',
    'ind.hos.3': 'Upit i rezervacija kako gost stvarno ide',
    'ind.mfg': 'Proizvodnja i industrija',
    'ind.mfg.1': 'Šta praviš, kome, kako se naručuje — tim redom',
    ...
    'ind.health.3': 'Alati oko pravog posla, sa zaključanim vratima',
    'ind.creative': 'Foto, video, kreativci',
    'ind.creative.1': 'Rad koji se proda, ne galerija koja samo stoji lepo',
    ...
    'ind.sport.3': 'Kupi, zakaži ili se prijavi tu — ne u DM-u na dnu Instagrama',
    'ind.law': 'Advokati i kancelarije',
    'ind.law.1': 'Da li uzimate ovaj slučaj — odgovor pre poziva',
    'ind.law.2': 'Oblasti rada bez zida tuđih reči',
    'ind.law.3': 'Jedna stvar: zakaži razgovor, ne „kontaktirajte kancelariju“',

    'price.eyebrow': 'Paketi i pare',
    'price.h2': 'Šta ti treba. Koliko košta.',
    'price.lead': 'Tri paketa. Kalkulator ispod kaže poštenu cifru za ono što čekiraš. Konačna cena se dogovori na pozivu od pola sata.',
    'price.ranges': 'Paketi',
    'price.launch.copy': 'Jedna ponuda. Jedan put. Sajt koji može da proda ili da uzme termin — ne brošura koja stoji lepo.',
    'price.growth.copy': 'Prodavnica, termini, ili duži sajt. Isti posao: da shvate, pa da plate.',
    'price.custom.price': 'Zakaži poziv',
    'price.custom.copy': 'Aplikacija, čudan spoj stvari, ili nešto što kalkulator ne ume da sračuna. To merimo u razgovoru.',
    'price.rec': 'Ovo uzimaju najčešće',
    'price.type': 'Šta praviš',
    'price.kind.site': 'Sajt',
    'price.kind.app': 'Aplikacija',
    'price.pages': 'Koliko strana',
    'price.pages.1': '1 strana',
    'price.cms': 'CMS',
    'price.cms.none': 'Bez CMS-a',
    'price.cms.cms': 'CMS',
    'price.cms.shop': 'Prodavnica (kasa)',
    'price.addons': 'Još uz to',
    'price.addon.ecom': 'Dodaci za prodavnicu',
    'price.addon.member': 'Članarina',
    'price.addon.book': 'Termini',
    'price.plats': 'Gde ide',
    'price.plat.pwa': 'PWA / sajt-aplikacija',
    'price.screens': 'Ekrani',
    'price.mods': 'Šta aplikacija ume',
    ...
    'form.notesPh': 'Šta ljudi treba da urade kad uđu?',
    'form.company': 'Firma',
    'form.send': 'Pošalji',
    'form.sending': 'Šaljem…',
    ...
    'form.err.fields': 'Treba mi ime i email koji radi, da znam kome da se javim.',
    'form.err.send': 'Nije prošlo. <a href="{mailto}">Pošalji mi mejl direktno</a> ili <a href="{cal}" target="_blank" rel="noopener noreferrer">zakaži poziv</a>.',
    ...
    'fb.1.p': '„Ranije su ulazili na staru stranu i opet pitali šta su tih 90 dana. Sad im to sajt kaže, pa se jave oni koji već znaju šta kupuju.“',
    'fb.1.name': 'Trener, Srbija',
    'fb.1.role': 'Busy Strong 90 · sajt programa',
    'fb.2.h': 'Lepo ne plaća kiriju. Plaćaju ljudi koji treniraju.',
    'fb.2.p': '„Ne živim od toga što brend izgleda skupo. Živim kad zauzeti ljudi plate trening i stvarno dođu. Sajt im to kaže pre nego što mi pišu. Aplikacija je gde ostanu i ne nestanu posle prve nedelje. To je zatvorilo rupu — koji su posle razgovora nestajali, sad plate, uđu i rade. To mi je posao. To je ovo uradilo.“',
    'fb.2.role': 'Trener',
    'fb.3.h': 'Kupovina više nije muka.',
    'fb.3.p': '„Ručne stvari je i onako teško prodati preko neta, a da ti sajt još smeta. Sad se vidi šta kupuješ, a kasa je kratka, nije lavirint.“',
    ...
    'ticker.aria': 'Poruke',
    'ticker.1': 'Sajt treba da ti donosi pare — ne samo da stoji lepo',
    'ticker.2': 'Posete bez poziva su bačeni novac',
    'ticker.3': 'Šta nudiš. Kuda idu. Šta da kliknu.',
    'ticker.4': 'Prestani da sređuješ strane koje niko ne koristi',
    'ticker.5': 'Daj im ponudu koju ne mogu da preskoče',
    'ticker.6': 'Zakaži poziv. Dogovorimo. Pustimo sajt koji prodaje',
    'ticker.7': 'Ako ne shvate odmah — prodao si vazduh',
    'ticker.8': 'Lepo sme. Klijenti koji plate nisu po želji',

    'faq.eyebrow': 'Pre poziva',
    'faq.h2': 'Bez uvijanja.',
    'faq.q1': 'Koliko traje sajt?',
    'faq.a1': 'Launch obično 3–4 nedelje. Growth (prodavnica, termini, duži sajt) oko 5. Sat krene posle poziva, kad znamo šta nudiš i koje strane treba — ne posle „hajde da napravimo neki sajt“.',
    'faq.q2': 'Šta dobijem u ceni?',
    'faq.a2': 'Tekst, izgled, telefon, jedan put do kupovine ili termina, i puštanje. Dobiješ sajt koji može da uzme pare, ne maketu. CMS, prodavnica, članarina — to čekiraš u kalkulatoru.',
    'faq.q3': 'Šta je održavanje mesečno?',
    'faq.a3': 'Hosting, sitne izmene, i da sajt ne crkne posle puštanja. Kalkulator pokaže mesečni iznos pored izrade. Možeš bez toga i da držiš sam; većina neće, jer pokvarena stvar posle košta više.',
    ...
    'faq.q5': 'Kako to ide od poziva do sajta?',
    'faq.a5': 'Pričamo, sredimo šta nudiš, pravim, puštam. Dok nije jasno za koga je i šta da kliknu, ne crtamo. Gledaš na pravom linku. Kad izađe, može da proda.',
    'faq.q6': 'Moram li da zakažem poziv da vidim cenu?',
    'faq.a6': 'Ne. Kalkulator ti da okvir. Na pozivu zatvorimo šta tačno ulazi i koliko. Ako hoćeš prvo da čuješ čoveka, uzmi pola sata.',
    'faq.q7': 'Imam sajt. Možeš li da ga središ?',
    'faq.a7': 'Mogu, ako ne prodaje jer se ne vidi šta nudiš ili kuda da idu — ne ako hoćeš „malo plavlju plavu“. Što radi, ostaje. Što curi, seče se. To je obično Launch ili Growth iznova, ne premaz.',
    ...
    'legal.privacy.title': 'Privatnost — G8 Flow',
    'legal.privacy.desc': 'Kako postupam sa onim što mi pošaljete preko forme, zakazivanja i analitike.',
    ...
    'legal.privacy.p.who': 'Sajt vodi <strong>G8 Flow</strong> (Goran Šantić). Radim sam — dizajn i izrada sajtova — iz Srbije. Za pitanja o podacima: <a href="mailto:goransantic92@gmail.com">goransantic92@gmail.com</a>.',
    'legal.privacy.h.what': 'Šta uzimam i zašto',
    'legal.privacy.h.form': 'Formular',
    'legal.privacy.p.form': 'Kad pošaljete formu u delu sa cenama, stigne mi ime, email, budžet, šta Vam treba i cifra iz kalkulatora. To koristim samo da Vam se javim i da spremim ponudu. Mejl u sanduče šalje <a href="https://resend.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">Resend</a>, u moje ime.',
    ...
    'legal.privacy.p.analytics': 'Koristim Vercel Web Analytics da vidim koje strane i dugmad se koriste. Nema kolačića, ne pravim profil o Vama i ne pratim Vas po drugim sajtovima. Beleži zbirno: koju stranu, odakle ste došli, zemlju, tip uređaja i koje dugme ste kliknuli. Detalji su u <a href="https://vercel.com/docs/analytics/privacy-policy" target="_blank" rel="noopener noreferrer">Vercelovom obaveštenju</a>.',
    'legal.privacy.h.logs': 'Tehnički zapisi',
    'legal.privacy.p.logs': 'Sajt je na Vercelu. On kratko drži tehničke zapise (IP, pregledač, vreme) zbog bezbednosti. Forma za upit drži Vašu IP u memoriji par sekundi da uspori spam; ne čuva je.',
    ...
    'legal.privacy.li.3': 'Forma Vas ne upisuje na nikakav mejling',
    'legal.privacy.li.4': 'Nema automatskih odluka ni profilisanja',
    'legal.privacy.h.basis': 'Pravni osnov',
    'legal.privacy.p.basis': 'Gde važi GDPR, oslanjam se na Vaš pristanak i na legitiman interes da odgovorim na poslovne upite i da sajt ostane bezbedan (čl. 6(1)(a) i 6(1)(f) GDPR).',
    'legal.privacy.h.keep': 'Koliko dugo čuvam',
    'legal.privacy.p.keep': 'Mejlove sa upitima držim dok je razgovor još posao, najduže 24 meseca posle poslednjeg kontakta, pa ih brišem. Papire uz potpisan projekat čuvam koliko traži knjigovodstvo. Analitika je zbirna i Vercel je drži po svojim pravilima.',
    'legal.privacy.h.whoelse': 'Ko još vidi podatke',
    'legal.privacy.p.whoelse': 'Samo servisi bez kojih sajt ne radi i bez kojih Vam ne mogu da odgovorim: Vercel (hosting, analitika), Resend (mejl), Calendly (termini) i moj email. Nikome drugom ne dajem podatke, osim ako to zakon traži.',
    ...
    'legal.terms.p.est': 'Kalkulator daje grubi okvir po onome što čekirate. To nije ponuda, ni obećanje cene ni roka. Tačan obim, cena, rate i datumi stoje u pisanom predlogu posle poziva. Gde paket stoji kao raspon, konačna cifra zavisi od obima, da li je sadržaj spreman, i od povezivanja sa drugim servisima.',
    ...
    'legal.terms.p.fb': 'Tekstovi dolaze od stvarnih klijenata. Neki su sa imenom i slikom uz dozvolu; drugi samo po ulozi i projektu, jer su tako hteli. Citati mogu da se skrate ili prevedu, nikad da se izokrene smisao.',
    ...
    'legal.terms.h.own': 'Čije je šta',
    'legal.terms.p.own': 'Kad je poslednja faktura plaćena, Vaš je dizajn i kod urađen za projekat. Stvari sa strane — fontovi, dodaci, slike, alati, hosting — ostaju pod svojim licencama, koje Vi držite. Gotov rad mogu da pokažem u portfoliju, osim ako pismeno dogovorimo da neću.',
    ...
    'legal.terms.h.third': 'Tuđi servisi',
