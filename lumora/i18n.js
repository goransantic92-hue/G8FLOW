...
(function (global) {
  ...
  const sr = {
    'meta.title': 'G8 Flow — Sajtovi koji rade za vaš biznis',
    'meta.desc': 'Pravim sajtove koji prodaju. Odmah se vidi šta nudite, kuda treba ići i šta kliknuti — da poseta postane poziv, kupovina ili termin.',
    ...
    'nav.contact': 'Kontakt',
    'nav.menu': 'Meni',
    'nav.open': 'Otvorite meni',
    'nav.close': 'Zatvorite',
    'nav.startProject': 'Hajde da razgovaramo →',
    'lang.label': 'Jezik',
    'lang.en': 'Engleski',
    'lang.sr': 'Srpski',

    'hero.h1a': 'Neka vaš sajt',
    'hero.h1b': 'radi za vas',
    'hero.lead': 'Većina sajtova izgleda skupo, a ne proda ništa. Pravim sajtove na kojima se odmah vidi šta nudite, kuda treba ići i šta kliknuti — da posetilac zna šta da uradi.',
    'hero.scroll': 'Skrolujte dalje',
    'cta.talk': 'Hajde da razgovaramo',
    'cta.viewWork': 'Pogledajte radove',
    'cta.book': 'Zakažite poziv',
    'cta.seeWork': 'Pogledajte radove',
    'cta.startBuild': 'Započnite projekat',
    'cta.workWithMe': 'Radimo zajedno',
    'cta.seeNumber': 'Pogledajte cenu',
    'cta.buildThis': 'Izaberite ovaj paket',
    'cta.estimate': 'Zatražite procenu',

    'work.eyebrow': 'Radovi',
    'work.h2': 'Pogledajte šta mogu da napravim.',
    'work.gallery': 'Galerija izabranih radova',
    'work.pause': 'Zaustavite pregled',
    'work.play': 'Pustite pregled',
    'work.slide': 'Rad {n} od {total}: {title}',
    'work.visit': 'Otvorite {host}',
    'work.bs.services': 'Sajt za prodaju programa',
    'work.bs.copy': 'Program je bio dobar. Sajt nije. Posetioci nisu znali za koga je, kako izgleda 90 dana rada ni gde da plate. Složio sam ga kao razgovor sa trenerom: problem, obećanje, put i kupovina u jednom koraku. Ceo sajt — tekst, mobilni prikaz i put do plaćanja. Ne katalog.',
    'work.bs.copyMobile': 'Nisu znali za koga je ni gde da plate. Složio sam redosled: problem, obećanje, kupovina.',
    'work.lk.services': 'Online prodavnica',
    'work.lk.copy': 'Lenkolino pravi dekor za dečije sobe — balone, čestitke i poklone po meri. Na starom sajtu je kupovina delovala kao još jedan posao. Napravio sam prodavnicu na kojoj se odmah vidi proizvod, zašto da verujete i gde je kasa. Korpa i proizvodi, ne lep katalog sa formularom na dnu. Growth paket, u dogovorenom roku.',
    'work.lk.copyMobile': 'Prodavnica dekora za dečije sobe. Vidi se proizvod, poverenje i kasa — bez lutanja.',
    'work.tm.services': 'Lični sajt · zakazivanje',
    'work.tm.copy': 'Marina ima praksu. Ko je otvorio stari sajt nije video šta nudi, ni kako da zakaže termin. Napravio sam sajt oko nje: ko je, šta radi i uvodni razgovor od 30 minuta u kalendaru. Launch paket — tekst, struktura i zakazivanje, spremno pre lansiranja.',
    'work.tm.copyMobile': 'Nije se videlo šta nudi ni kako da se zakaže. Sad: ko je, šta radi i termin od 30 minuta.',
    'work.stat.build': 'Trajanje izrade',
    'work.stat.launchRange': 'Launch paket',
    'work.stat.growthRange': 'Growth paket',
    'work.stat.sales': 'Prodaja preko sajta',
    'work.stat.booking': 'Zakazivanje',
    ...
    'about.lead': 'Ja sam Goran. Sajt treba da vam donosi posao, ne da lepo stoji. Ako vam ljudi otvore stranicu i odu — nije im jasno šta nudite, kuda idu ni šta da kliknu. To sređujem. Ko vas vidi prvi put, odmah treba da zna šta da uradi.',
    'about.photo': 'Goran — G8 Flow',
    ...
    'sol.eyebrow': 'Usluge',
    'sol.h2': 'Sve što vam treba na netu.',
    'sol.lead': 'Bez tehničkog žargona. Vi vodite posao — ja vodim računa da vas klijenti nađu, razumeju i plate.',
    'sol.web.kicker': '01 Sajtovi i platforme',
    'sol.web.title': 'Brzi i responzivni sajtovi',
    'sol.web.text': 'Prvo razumem problem, ko dolazi na sajt i šta treba da urade. Odatle se pravi sajt — jasan, brz i spreman da proda, ne obrnuto.',
    'sol.app.kicker': '02 Mobilne aplikacije',
    'sol.app.title': 'Mobilne aplikacije po meri',
    'sol.app.text': 'Ne radim šablonska rešenja. Svaka aplikacija ide od toga za koga je, preko prototipa, do proizvoda koji ljudi zaista otvore.',

    'ind.eyebrow': 'Industrije',
    'ind.h2': 'Različite industrije, različita pravila. Cilj je isti: da vas razumeju, pa da kupe.',
    'ind.ecom': 'E-commerce i maloprodaja',
    'ind.ecom.1': 'Online prodavnica na kojoj se vidi zašto da kupe, ne samo slika i cena',
    'ind.ecom.2': 'Plaćanje koje ne izgleda kao dodatni posao',
    'ind.ecom.3': 'Kartica, dostava i stanje zaliha — da zaista možete da prodajete',
    'ind.ecom.4': 'Katalozi koji ostaju brzi i kad lista poraste',
    'ind.re': 'Građevina i nekretnine',
    'ind.re.1': 'Sajt koji pokazuje objekat, ne gomilu PDF dokumenata',
    'ind.re.2': 'Jedan sledeći korak: upit, razgledanje ili ponuda',
    'ind.re.3': 'Upiti, ponude i tok projekta na jednom mestu, ako vam treba',
    'ind.hos': 'Ugostiteljstvo i turizam',
    'ind.hos.1': 'Rezervacija bez telefona napred-nazad',
    'ind.hos.2': 'Ponuda, sobe i poverenje u jednom prolazu',
    'ind.hos.3': 'Upit i rezervacija onako kako gost zaista ide',
    'ind.mfg': 'Proizvodnja i industrija',
    'ind.mfg.1': 'Šta proizvodite, kome je namenjeno i kako se naručuje — tim redom',
    'ind.mfg.2': 'Tehnički podaci koji ne ubijaju prodaju',
    'ind.mfg.3': 'Zahtev za ponudu koji prodaja može odmah da koristi',
    'ind.health': 'Zdravstvo i wellness',
    'ind.health.1': 'Za koga je i šta je termin — pre nego što odu',
    'ind.health.2': 'Zakazivanje na sajtu, ne „pišite nam na email“',
    'ind.health.3': 'Alati oko pravog toka rada, sa zaključanim pristupom',
    'ind.creative': 'Kreativne industrije i mediji',
    'ind.creative.1': 'Rad koji se prodaje, ne galerija koja samo lepo stoji',
    'ind.creative.2': 'Velike slike koje se i dalje brzo otvaraju',
    'ind.creative.3': 'Jedan put od „sviđa mi se“ do uplate',
    ...
    'ind.sport.3': 'Kupovina, termin ili prijava na sajtu — ne u poruci na Instagramu',
    ...
    'ind.law.3': 'Jedan korak: zakažite razgovor, ne „kontaktirajte kancelariju“',

    'price.eyebrow': 'Paketi',
    'price.h2': 'Paket za svaki korak vašeg biznisa.',
    'price.lead': 'Tri paketa. Izaberite onaj koji odgovara vašem poslu — kalkulator ispod daje okvirnu cenu. Konačan iznos dogovaramo na pozivu od 30 minuta.',
    'price.ranges': 'Paketi',
    'price.launch.copy': 'Za biznise kojima treba jedna jasna ponuda i jedan put do kupovine ili termina — ne brošura koja samo lepo stoji.',
    'price.growth.copy': 'Za biznise kojima treba prodavnica, zakazivanje ili duži sajt. Isti cilj: da vas razumeju, pa da plate.',
    'price.custom.price': 'Zakažite poziv',
    'price.custom.copy': 'Aplikacije i nestandardni projekti. Obim i cenu merimo u razgovoru — bez nagađanja u kalkulatoru.',
    'price.rec': 'Najčešći izbor',
    'price.type': 'Šta pravimo',
    ...
    'price.note': 'Ovo je okvir. Tačna cena sledi posle poziva od 30 minuta.',
    ...
    'form.company': 'Firma',
    'form.send': 'Pošaljite poruku',
    'form.sending': 'Šaljem…',
    'form.ok': 'Poruka je stigla. Javljam se u toku radnog dana.<br><a href="https://calendly.com/goransantic/30min" target="_blank" rel="noopener noreferrer">Zakažite odmah termin od 30 minuta</a> ako želite da cenu zatvorimo danas.',
    'form.err.fields': 'Treba mi ime i ispravan email, da znam kome da se javim.',
    'form.err.send': 'Slanje nije uspelo. <a href="{mailto}">Pošaljite mi email direktno</a> ili <a href="{cal}" target="_blank" rel="noopener noreferrer">zakažite poziv</a>.',
    ...
    'fb.stars': '5 od 5',
    'fb.1.h': 'Sajt kaže šta nudite pre nego što vas zovu.',
    ...
    'ticker.aria': 'Poruke',
    'ticker.1': 'Sajt treba da vam donosi posao — ne samo da lepo izgleda',
    'ticker.2': 'Posete bez poruka su bačen novac',
    'ticker.3': 'Jasno šta nudite, kuda idu i šta da kliknu',
    'ticker.4': 'Prestajte da sređujete stranice koje niko ne koristi',
    'ticker.5': 'Dajte im ponudu koju ne mogu da preskoče',
    'ticker.6': 'Zakažite poziv. Dogovorimo. Lansiramo sajt koji prodaje',
    'ticker.7': 'Ako ne shvate odmah — prodaja vam curi',
    'ticker.8': 'Dizajn sme da bude lep. Klijenti koji plate nisu opcija',

    'faq.eyebrow': 'Pre poziva',
    'faq.h2': 'Jasni odgovori, bez uvijanja.',
    'faq.q1': 'Koliko traje izrada sajta?',
    'faq.a1': 'Launch obično traje 3–4 nedelje. Growth (prodavnica, zakazivanje, duži sajt) oko 5. Rad kreće posle poziva, kad znamo šta nudite i koje stranice treba — ne posle „hajde da napravimo neki sajt“.',
    'faq.q2': 'Šta dobijate u ceni?',
    'faq.a2': 'Tekst, izgled, mobilni prikaz, jedan put do kupovine ili termina, i lansiranje. Dobijate sajt koji može da primi poruku, uplatu ili termin — ne maketu. CMS, prodavnicu i članarinu čekirate u kalkulatoru.',
    'faq.q3': 'Šta je mesečno održavanje?',
    'faq.a3': 'Hosting, sitne izmene i to da sajt ostane u funkciji posle lansiranja. Kalkulator pokazuje mesečni iznos pored izrade. Možete i bez toga, da ga držite sami; većina neće, jer pokvarena stvar posle košta više.',
    'faq.q4': 'Za koga radim ovo?',
    'faq.a4': 'Za ljude koji već nešto prodaju — trening, radnju, praksu — a sajt izgleda u redu i ne donosi ništa. Ako vam treba konkurs za logo ili knjiga od 40 strana, nismo za to.',
    'faq.q5': 'Kako ide od poziva do sajta?',
    'faq.a5': 'Razgovor, dogovor, izrada, lansiranje. Prvo 30 minuta bez obaveze. Dok nije jasno za koga je sajt i šta da kliknu, ne crtamo. Gledate na pravom linku. Kad ide uživo, može da proda.',
    'faq.q6': 'Morate li da zakažete poziv da vidite cenu?',
    'faq.a6': 'Ne. Kalkulator daje okvir. Na pozivu zatvorimo šta tačno ulazi i koliko košta. Ako prvo želite da čujete čoveka, uzmite 30 minuta.',
    'faq.q7': 'Imam sajt. Možete li da ga sredite?',
    'faq.a7': 'Mogu, ako ne prodaje zato što se ne vidi šta nudite ili kuda da idu — ne ako želite „malo plavlju plavu“. Što radi, ostaje. Što curi, seče se. To je obično Launch ili Growth iznova, ne premaz.',

    'foot.h2a': 'Neka vaš sajt',
    'foot.h2b': 'radi za vas.',
    'foot.tag': 'Sajtovi koji donose posao. Jasno šta nudite, čisto urađeno, i put od posete do zakazanog poziva.',
    'foot.explore': 'Sajt',
    'foot.start': 'Početak',
    ...
    'legal.privacy.p.book': 'Dugme „Zakažite poziv“ otvara <a href="https://calendly.com/legal/privacy-notice" target="_blank" rel="noopener noreferrer">Calendly</a>. Kad uzmete termin, Calendly obrađuje ono što unesete po svojim pravilima i meni pošalje termin.',
    ...
    'legal.terms.p.pay': 'Ako predlog ne kaže drugačije, plaća se na rate — avans unapred, ostatak pre lansiranja. Cene su u evrima, bez poreza i naknada u Vašoj zemlji. Mesečno održavanje se plaća unapred i može da se otkaže uz 30 dana najave.',
